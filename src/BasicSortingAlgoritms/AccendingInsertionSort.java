...
public class AccendingInsertionSort
{
	...
	// (i) This is the insertion sorting algorithm in ACCENDING order
	...
	public static void insertionSort(Integer[] array) {
		for (int i = 1; i < array.length; i++) {
			...
			// Move elements of array that are greater than key. Swap > to < for DECENDING order
